...
class CustomFolder extends CustomPainter {
  Path folderClipper({required double radius, required Size size}) {
    ...
    final path2 = Path()
      ...
      ..arcToPoint(Offset(size.width, size.height / 4 + radius), radius: Radius.circular(radius))
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path0 = Path()
      ...
      ..arcToPoint(Offset(5 * size.width / 6 + radius0 - 2, 15), radius: Radius.circular(radius0))
    ...
    final path1 = Path()
      ...
      ..arcToPoint(Offset(size.width - 2, size.height / 8 + 15), radius: const Radius.circular(radius1))
