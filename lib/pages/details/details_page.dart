...
class DetailsPage extends StatefulWidget {
  static route() => MaterialPageRoute(builder: (context) => const DetailsPage());
...
class _DetailsPageState extends State<DetailsPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    tabController.animation!.drive(AlignmentTween(begin: Alignment.centerLeft, end: Alignment.centerRight));
    super.initState();
  }
