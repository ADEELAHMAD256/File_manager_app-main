                  ...
                  child: CustomPaint(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomIcon(iconData: FluentIcons.folder_48_filled, color: recentFolder.color),
                          const Spacer(),
                          Text(
                          ...
                          const Spacer(),
                          Text(recentFolder.folderInfo, style: primaryTextTheme.titleMedium!),
                        ],
                      ),
                    ),
                  ),
                ...
                Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: primaryTextTheme.titleMedium!.copyWith(fontWeight: FontWeight.bold),
                    ),
                    const Text("4.5 MB"),
                  ],
                )
