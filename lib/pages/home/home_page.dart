...
class HomePage extends StatelessWidget {
          ...
          child: ListView(
            ...
            children: [
              ...
              BounceAnimation(
                ...
                child: Text(
                  "Overview",
                  style: primaryTextTheme.titleLarge!.copyWith(fontWeight: FontWeight.bold),
                ),
              ),
  ...
  Row _buildHeader(TextTheme primaryTextTheme) {
    return Row(
      children: [
        const CircleAvatar(radius: 30, backgroundImage: AssetImage('assets/avatar.jpg')),
        SizedBox(width: 10.w),
        Column(
  ...
  InkWell _buildStorageOverview(BuildContext context, TextTheme primaryTextTheme) {
    return InkWell(
                    ...
                    child: RotatedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "85%",
                            style: primaryTextTheme.headlineLarge!.copyWith(fontWeight: FontWeight.bold),
                          )
                        ],
                      ),
                    ),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          '51 GB',
                          style: primaryTextTheme.headlineSmall!.copyWith(fontWeight: FontWeight.bold),
                        ),
                      ],
                    ),
                  ],
